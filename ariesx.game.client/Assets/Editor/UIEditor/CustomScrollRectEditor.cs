...
namespace UnityEditor.UI {
    ...
    public class CustomScrollRectEditor : Editor {
        ...
        void SetAnimBools(bool instant) {
            SetAnimBool(m_ShowElasticity, !m_MovementType.hasMultipleDifferentValues && m_MovementType.enumValueIndex == (int)CustomScrollRect.MovementType.Elastic, instant);
        ...
        void CalculateCachedValues() {
            ...
            if (targets.Length == 1) {
                Transform transform = ((CustomScrollRect)target).transform;
        ...
        public override void OnInspectorGUI() {
            ...
            if (m_HorizontalScrollbar.objectReferenceValue && !m_HorizontalScrollbar.hasMultipleDifferentValues) {
                ...
                if ((CustomScrollRect.ScrollbarVisibility)m_HorizontalScrollbarVisibility.enumValueIndex == CustomScrollRect.ScrollbarVisibility.AutoHideAndExpandViewport
            ...
            if (m_VerticalScrollbar.objectReferenceValue && !m_VerticalScrollbar.hasMultipleDifferentValues) {
                ...
                if ((CustomScrollRect.ScrollbarVisibility)m_VerticalScrollbarVisibility.enumValueIndex == CustomScrollRect.ScrollbarVisibility.AutoHideAndExpandViewport
