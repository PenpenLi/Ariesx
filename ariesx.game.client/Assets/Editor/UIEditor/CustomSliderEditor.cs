...
namespace UnityEditor.UI {
    ...
    public class SliderEditor : SelectableEditor {
        ...
        protected override void OnEnable() {
            ...
            m_Value = serializedObject.FindProperty("currentValue");
        ...
        public override void OnInspectorGUI() {
            ...
            if (m_FillRect.objectReferenceValue != null || m_HandleRect.objectReferenceValue != null) {
                ...
                if (EditorGUI.EndChangeCheck()) {
                    CustomBaseSlider.Direction direction = 
                        (CustomBaseSlider.Direction)m_Direction.enumValueIndex;
                    foreach (var obj in serializedObject.targetObjects) {
                        CustomSlider slider = obj as CustomSlider;
                ...
                bool warning = false;
                foreach (var obj in serializedObject.targetObjects) {
                    CustomBaseSlider slider = obj as CustomBaseSlider;
                    CustomBaseSlider.Direction dir = slider.direction;
                    if (dir == CustomBaseSlider.Direction.LeftToRight || dir == CustomBaseSlider.Direction.RightToLeft)
