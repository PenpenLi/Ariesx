    ...
    public class Adjust : MonoBehaviour {
        ...
        void Awake() {
            ...
            if (!this.startManually) {
                ...
                adjustConfig.setLogDelegate(msg => { });// UnityEngine.Debug.Log(msg));
        ...
        //SDK Event Track
        public void AchievedLevel6() {
            AdjustEvent AchievedLevel6 = new AdjustEvent("nbgl5x");
            Adjust.trackEvent(AchievedLevel6);
            //new AdjustEvent("nbgl5x").setRevenue(0.01, "USD");
            //Adjust.trackEvent(new AdjustEvent("nbgl5x"));
        }
        ...
        public void CompletedTutorial() {
            AdjustEvent CompletedTutorial = new AdjustEvent("9obko3");
            Adjust.trackEvent(CompletedTutorial);
        }
