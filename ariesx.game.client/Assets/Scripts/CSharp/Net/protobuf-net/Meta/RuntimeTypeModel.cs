...
,
        ...
        internal void VerifyFactory(MethodInfo factory, Type type)
        {
            if (factory != null)
            {
                ...
                if ((type != null && factory.ReturnType != type) && factory.ReturnType != MapType(typeof(object))) throw new ArgumentException("The factory-method must return object" + (type == null ? string.Empty : (" or " + type.FullName)), "factory");
