...
namespace UnityEngine.UI {
    ...
    public abstract class CustomLayoutGroup : UIBehaviour, ILayoutElement, ILayoutGroup {
        [SerializeField]
        ...
        public virtual void CalculateLayoutInputHorizontal() {
            ...
            for (int i = 0; i < rectTransform.childCount; i++) {
                ...
                int toIgnoreListCount = toIgnoreList.Count;
                if (toIgnoreListCount == 0) {
                    m_RectChildren.Add(rect);
                    continue;
                }

                for (int j = 0; j < toIgnoreListCount; j++) {
