...
namespace Poukoute {
    ...
    public class BattleView : BaseView {
        ...
        void Awake() {
            this.viewModel = this.GetComponent<BattleViewModel>();
            this.ui = GameObject.Find("UIBattle");
            ...
            this.ui.transform.parent.GetComponent<CanvasScaler>().matchWidthOrHeight =
        ...
        private void InitBattleUI() {
            ...
            //this.viewPref.rectAttack.sizeDelta =
            //    new Vector2(this.viewPref.rectAttack.sizeDelta.x, MapUtils.UIRect.height / 2 - 1);
            //this.viewPref.rectAttack.anchoredPosition =
            //    new Vector2(this.viewPref.rectAttack.anchoredPosition.x, this.viewPref.rectAttack.sizeDelta.y / 2);
            //this.viewPref.rectDefense.sizeDelta =
            //    new Vector2(this.viewPref.rectDefense.sizeDelta.x, MapUtils.UIRect.height / 2 - 1);
            //this.viewPref.rectDefense.anchoredPosition =
            //    new Vector2(this.viewPref.rectDefense.anchoredPosition.x, -this.viewPref.rectDefense.sizeDelta.y / 2);
            ...
            //this.viewPref.btnFold.onClick.AddListener(this.OnBtnFoldClick);
            this.viewPref.btnClose.onClick.AddListener(this.OnBtnCloseClick);
            bool isFte = FteManager.CheckFte(GameConst.NORMAL, 59) ||
                FteManager.CheckFte(GameConst.NORMAL, 481);
            this.viewPref.btnFteMask.gameObject.SetActiveSafe(isFte);
            //this.viewPref.pnlButtons.gameObject.SetActive(!isFte);
            this.viewPref.btnPlaySpeed.gameObject.SetActive(!isFte);
        ...
        private void PlayEnd() {
            if (FteManager.CheckFte(GameConst.NORMAL, 481)) {
                    ...
                    if (this.viewModel.Win) {
                        ...
                        if (this.viewPref.cgReward != null) {
                            Vector2 rewardPosition =
                                this.pnlReward.GetComponent<RectTransform>().anchoredPosition;
        ...
        public void Play() {
            ...
            //this.PlayAction(this.viewModel.BattleRounds, 0, 0);
            //this.PlayEnd();
        }

        private IEnumerator PlayAction(Battle.ReportRounds rounds, int roundIndex, int actionIndex) {
            //yield return new WaitForSeconds(0.2f / this.viewModel.PlaySpeed);
        ...
        #region FTE
        public void OnFteStep241End() {
            this.viewPref.btnFteMask.onClick.RemoveAllListeners();
            this.viewPref.btnFteMask.onClick.AddListener(() => {
                this.OnBtnCloseClick();
                FteManager.StartFte();
            });
            this.viewPref.btnFteMask.gameObject.SetActiveSafe(true);
        }

        public void OnFteStep481End() {
            StartCoroutine(this.DelayOnFteStep481End());
        }

        private IEnumerator DelayOnFteStep481End() {
        ...
        private IEnumerator WaitForFight() {
            yield return YieldManager.GetWaitForSeconds(200);
        }
        #endregion

        //void OnEnable() {
        //    // this.ui.gameObject.SetActiveSafe(true);
        //}
