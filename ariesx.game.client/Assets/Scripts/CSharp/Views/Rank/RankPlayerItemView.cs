...
namespace Poukoute {
    ...
    public class RankPlayerItemView: BaseItemViewsHolder {
        [HideInInspector]
        ...
        private void OnRankDataChange() {
            ...
            this.imgRank.sprite = ArtPrefabConf.GetRankIcon(personalRankData.Rank, this.rank);
            ...
            if (this.viewType == RankItemViewType.OwnRankView) {
                ...
                this.txtPlayerName.StripLengthWithSuffix(personalRankData.Name);
                this.ResetRangeInfo(personalRankData.Rank, personalRankData.RankBefore);
            }
