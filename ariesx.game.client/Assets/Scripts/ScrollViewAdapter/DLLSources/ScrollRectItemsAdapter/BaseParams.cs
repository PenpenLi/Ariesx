...
namespace frame8.Logic.Misc.Visual.UI.ScrollRectItemsAdapter
{
	...
	public class BaseParams
	{
		...
		[SerializeField]
        public float _DefaultItemSize = 90f;
		#endregion
        ...
        public BaseParams(CustomScrollRect scrollRect)
            :this(scrollRect, scrollRect.transform as RectTransform, scrollRect.content)
        {}

        public BaseParams(CustomScrollRect scrollRect, RectTransform viewport, RectTransform content)
        {
