...
namespace frame8.Logic.Misc.Visual.UI.ScrollRectItemsAdapter {
    ...
    public class ItemsDescriptor {
        ...
        internal void BeginChangingItemsSizes(int indexInViewOfFirstItemThatWillChangeSize) {
            ...
            _IndexInViewOfLastItemThatChangedSizeDuringSizesChange =
                _IndexInViewOfFirstItemThatChangesSizeDuringSizesChange - 1;
            _CumulatedSizesUntilNowDuringSizesChange =
                _IndexInViewOfFirstItemThatChangesSizeDuringSizesChange == 0 ?
                0d : GetItemSizeCumulative(_IndexInViewOfFirstItemThatChangesSizeDuringSizesChange - 1);
        }
        ...
        internal void EndChangingItemsSizes() {
            ...
            var indexOfLastKeyThatChanged =
                _Keys.BinarySearch(_IndexInViewOfLastItemThatChangedSizeDuringSizesChange);
        ...
        internal double GetItemSizeCumulative(
            int itemIndexInView, bool allowInferringFromNeighborAfter = true) {
