...
namespace frame8.Logic.Misc.Other.Extensions {
    public static class RectTransformExtensions {
        ...
        _SetInsetAndSizeFromParentEdgeWithCurrentAnchors_MappedActions =
        ...
        public static float GetWorldSignedHorDistanceBetweenCustomPivots(
            this RectTransform rt, float customPivotOnThisRect01,
            RectTransform other, float customPivotOnOtherRect01) {
            // Horizontal distance
        ...
        public static void SetInsetAndSizeFromParentEdgeWithCurrentAnchors(this RectTransform child,
            ...
            _SetInsetAndSizeFromParentEdgeWithCurrentAnchors_MappedActions[fixedEdge](
                child, parentHint, newInset, newSize
             );
        }
